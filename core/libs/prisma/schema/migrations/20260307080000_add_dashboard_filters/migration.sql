...
-- AddForeignKey
ALTER TABLE `rpt_dashboard_filters` ADD CONSTRAINT `rpt_dashboard_filters_connection_id_fkey` FOREIGN KEY (`connection_id`) REFERENCES `rpt_db_connections`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
