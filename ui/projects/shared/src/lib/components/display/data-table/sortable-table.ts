...
export class SortableTable implements OnInit, AfterViewInit {
  ...
  constructor(private el: ElementRef, private renderer: Renderer2) {
    ...
    const sortState = linkedSignal(() => {
      ...
      if (this.currentKey === normalizedKey && this.currentDirection === normalizedDir) return null;
      ...
      return { key: normalizedKey, direction: normalizedDir };
    });
  }
