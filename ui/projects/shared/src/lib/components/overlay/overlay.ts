...
export class OverlayStore {
  ...
  openNearElement<T>(
    ...
    const dialogRef = this.dialog.open(component, {
      ...
      panelClass: [...this.basePanelClass, ...(options?.panelClass ?? ['rounded-3xl'])],
      data: data,
      autoFocus: false,
      providers: [
  ...
  openModal<T>(
    ...
    const dialogRef = this.dialog.open(component, {
      ...
      hasBackdrop: backdropConfig.hasBackdrop,
      backdropClass: backdropConfig.backdropClass,
      panelClass: [...this.basePanelClass, 'w-[500px]', 'max-h-[80%]', 'h-auto', 'rounded-xl', 'overflow-clip', 'overflow-y-scroll'],
      data: data,
      autoFocus: false,
      providers: [
        { provide: DIALOG_DATA, useValue: data }
