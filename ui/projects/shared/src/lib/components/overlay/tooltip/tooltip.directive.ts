...
export class TooltipDirective implements OnDestroy {
  ...
  private initializeTooltip() {
    if (this.componentRef !== null || !isPlatformBrowser(this.platformId)) {
      return; // Prevent creating multiple tooltip instances or running on server
    }
    ...
    if (this.document.body && tooltipDOMElement) {
