    ...
    <div class="w-full max-w-2xl mx-auto p-6 flex flex-col gap-6">
      ...
      <div class="flex items-center gap-2">
        <div *ngFor="let s of [1, 2, 3]; let i = index" class="flex items-center gap-2">
          ...
          <div *ngIf="i < 2" class="w-8 h-px bg-neutral-300"></div>
        </div>
      </div>
      ...
      <div *ngIf="step() === 1" class="flex flex-col gap-4">
        ...
        <div *ngIf="connectionList.isLoading()" class="text-neutral-500 text-sm">Loading connections...</div>
        <div class="grid grid-cols-1 gap-3">
          <div
            *ngFor="let conn of connectionList.value()?.data ?? []"
        ...
        <div *ngIf="!connectionList.isLoading() && !(connectionList.value()?.data?.length)" class="text-neutral-500 text-sm">
      ...
      <div *ngIf="step() === 2" class="flex flex-col gap-4">
        ...
        <div *ngIf="generateMutation.error()" class="text-red-600 text-sm">
      ...
      <div *ngIf="step() === 3" class="flex flex-col gap-4">
        ...
        <div *ngIf="generatedChart" class="flex flex-col gap-4">
          <!-- Chart preview -->
